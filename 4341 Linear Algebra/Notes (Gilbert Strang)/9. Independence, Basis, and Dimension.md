...
$$
\begin{bmatrix} 1 \\ 1 \\ 2 \end{bmatrix}, \begin{bmatrix} 2 \\ 2 \\ 5 \end{bmatrix}, \dots \text{(plus a 3rd independent vector)}
$$
If we put these vectors into a matrix and the matrix is **invertible**, the columns form a basis for $\mathbb{R}^n$.
